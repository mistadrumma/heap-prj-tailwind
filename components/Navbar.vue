...
<!--          &lt;!&ndash;          <img alt="Hugging Face's logo" class="md:mr-2 w-7" src="/front/assets/huggingface_logo-noborder.svg">&ndash;&gt;-->
...
<!--        </div>-->
<!--      </div>-->
      <nav v-if="user" class="fixed top-0 z-50 w-full bg-white border-b border-gray-200 dark:bg-gray-800 dark:border-gray-700">
