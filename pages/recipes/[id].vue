...
const recipe = ref({
  ...
  short_description: 'Soft and chewy chocolate chip cookies that are a classic dessert favorite',
  ingredients: [
    { id: 1, quantity: '1', unit: 'cup', name: 'butter' },
    { id: 2, quantity: '3/4', unit: 'cup', name: 'brown sugar' },
    { id: 3, quantity: '1/4', unit: 'cup', name: 'white sugar' },
    { id: 4, quantity: '1', unit: '', name: 'egg' },
    { id: 5, quantity: '1', unit: 'tsp', name: 'vanilla extract' },
    { id: 6, quantity: '1`', unit: 'tsp', name: 'baking soda' },
    { id: 7, quantity: '1/2', unit: 'tsp', name: 'salt' },
    { id: 8, quantity: '2', unit: 'cups', name: 'flour' },
    { id: 9, quantity: '1', unit: 'cup', name: 'chocolate chips' },
  ],
  steps: [
    { id: 1, description: 'Preheat oven to 350 degrees F (175 degrees C).' },
    { id: 2, description: 'Cream together the butter, brown sugar, and white sugar until smooth. Beat in the egg and vanilla.' },
    { id: 3, description: 'Dissolve baking soda in hot water. Add to batter along with salt. Stir in flour, chocolate chips, and nuts. Drop by large spoonfuls onto ungreased pans.' },
    { id: 4, description: 'Bake for about 10 minutes in the preheated oven, or until edges are nicely browned.' },
  ],
  notes: [
    { id: 1, description: 'For a softer cookie, bake for 8 minutes.' },
    { id: 2, description: 'For a crispier cookie, bake for 12 minutes.' },
  ],
  prepTime: 15,
  cookTime: 10,
  photo: 'https://images.unsplash.com/photo-1589988870029-8e8b0b2b0b1c?ixid=MnwxMjA3fDB8MHxzZWFyY2h8Mnx8Y2hvb2xhdGUlMjBjaGlwfGVufDB8fDB8&ixlib=rb-1.2.1&w=1000&q=80',
})
